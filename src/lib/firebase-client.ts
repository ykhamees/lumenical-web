...
// `next build`'s static-export prerender pass still executes client
// components once in Node to produce the initial HTML — Firebase's SDK
// expects a real browser and throws immediately on a missing/placeholder
// API key. Deferring initialization until an actual browser runs this
// keeps the build green with no Firebase config set, matching every other
// integration on this site (Turnstile, Plausible, the two forms).
